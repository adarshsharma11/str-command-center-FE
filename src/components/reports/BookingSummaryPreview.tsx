      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold mt-2">{data.total_nights}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-2xl font-bold mt-2">{formatCurrency(data.average_booking_value)}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <ChartContainer config={chartConfig} className="h-[200px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data.by_property} layout="vertical">
